    ...
    <Dashboard>
      <div>
        <div className="bg-[#F4F4F4] px-0 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-5 max-h-[700px] items-center border bg-[#fff] border-[#e4e2e2] md:my-10">
            ...
            <div className="lg:col-span-3 lg:block hidden">
              <div className="mx-20">
                <div className="flex flex-col items-center gap-4  pb-20 px-10 border-b border-[#e4e2e2]">
                  <Image
                    src="/catherine.png"
                    alt={"img"}
                    width={120}
                  ...
                  <div className="text-center text-[#6b7c93]">
                    <p className="mb-1.5 text-lg cursor-pointer">
                      (313) 867-0495
                    </p>
                    <p >Christine</p>
                    <p className="cursor-pointer">christine@outlook.com</p>
                  </div>
                </div>
